...
const whyUs = () => {
  return (
    <div className='  lg:p-[100px] p-[25px] w-screen lg:ml-[-100px] ml-[-20px]'>
        ...
        <br />
        <span className='text-2xl font-bold text-main '> Join us today and start your journey towards a brighter future!</span> 
        </p>
        </div>
        <Image className='w-[600px] border-dashed border-main border-2  rounded-md lg:mt-[-50px] rounded-tl-[150px] h-[400px] object-cover' src={pic} width={700} height={800}></Image>
