...
const home = () => {
  return (
    <div  id="home" className='flex   transition-all duration-500 justify-between pt-[50px] lg:px-[150px] pl-4 gap-32'>
  ...
  <br />
  <p className='text-2xl font-semibold max-w-[530px] text-[#575252] dark:text-[#ECD4D4]'>We give you access to the best courses to learn
